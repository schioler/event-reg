...
public class EventSearchDAOImpl implements EventSearchDAO {
	...
	@Override
	public List<MedicineFirm> searchEvents(LocalDateTime startTime, LocalDateTime endTime, List<Integer> templateIds, Integer loginId)
			throws DAOException {
