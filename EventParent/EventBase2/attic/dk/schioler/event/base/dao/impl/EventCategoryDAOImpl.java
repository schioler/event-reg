...
public class EventCategoryDAOImpl<T extends EventCategory> extends EntityBaseDAOImpl<EventCategory> implements EventCategoryDAO<EventCategory> {

   public EventCategoryDAOImpl() {      
      super(new EventCategoryTableImpl<EventCategory>());
   }
