...
@Service
public class StateAspectDAOImpl extends AbstractNameDAOImpl<MedicineEvent> implements StateAspectDAO {
   ...
   @Override
   protected boolean isValidInsertObject(MedicineEvent type) {
