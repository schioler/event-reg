...
public class StateRatingRowMapper extends StateRatingTableImpl implements RowMapper<BaseEvent>  {

   @Override
   public BaseEvent mapRow(ResultSet rs, int rowNum) throws SQLException {
      BaseEvent stateRating = new BaseEvent();

      stateRating.addEventId(rs.getInt(FLD_ID));
      stateRating.setLoginId(rs.getInt(FLD_OWNER_ID));
      stateRating.setCreatedTS(rs.getTimestamp(FLD_CREATED).toLocalDateTime());
