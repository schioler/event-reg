package dk.schioler.configuration;
...
//@ComponentScan("dk.schioler.event, dk.schioler.shared.security, dk.schioler.shared.timeline, dk.schioler.shared.bits")
public class EventBaseConfiguration4Test {

   Logger logger = LoggerFactory.getLogger(getClass());

   public EventBaseConfiguration4Test() {
