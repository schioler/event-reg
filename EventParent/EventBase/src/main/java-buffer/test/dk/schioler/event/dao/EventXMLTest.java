...
public class EventXMLTest extends AbstractJUnit4SpringContextTests {
	...
	public void testParseInputStream() {
		...
		List<AbstractEntityParentChild> eventTypes = xmlHelper.buildEventTypes(filePath);
		...
		assertEquals("MEDICIN-PARK", eType.getDescription());
				
		List<AbstractEntityParentChild> templates = eType.getChildren();
