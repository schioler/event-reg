 ...
 * Generated at: 2025-03-11 19:02:23 UTC
...
public final class event_002dtmpl_002dcreate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_fmt_005fbundle_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/event-tmpl-create.jsp(8,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      if (_jspx_eval_fmt_005fbundle_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<body>\r\n");
          out.write("   ");
          org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "event-tmpl-single.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("action", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("create", request.getCharacterEncoding()), out, false);
          out.write("\r\n");
          out.write("</body>\r\n");
          out.write("	");
