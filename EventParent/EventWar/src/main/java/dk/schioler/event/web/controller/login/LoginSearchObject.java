package dk.schioler.event.web.controller.login;
...
public class LoginSearchObject {
	...
	public LoginSearchObject(LocalDateTime loginTime, boolean isAuthenticated, Login login) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LoginSearchObject other = (LoginSearchObject) obj;
