...
public interface WebEntityEventType extends  WebEntityNamed {
    
   
//   public final static String SES_EVENT_TYPE = "30-event-type-list-show.do";
...
//   public static final String EVENT_TYPE_LIST_JSP = "30-event-type-list.jsp";
   ...
   public static final String EVENT_TYPE_CREATE_JSP = "30-event-type-create.jsp "; // create % update
   ...
   public static final String EVENT_TYPE_UPDATE_JSP = "30-event-type-update.jsp";
   ...
   public static final String EVENT_TYPE_DELETE_JSP = "30-event-type-delete.jsp";
