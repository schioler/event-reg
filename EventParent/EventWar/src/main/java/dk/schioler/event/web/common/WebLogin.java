...
public class WebLogin {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(authenticateTime, other.authenticateTime) && isAuthenticated == other.isAuthenticated
				&& Objects.equals(login, other.login) && Objects.equals(owner, other.owner);
	}
	...
	public String toString() {
		...
		if (owner != null) {
			builder.append("[owner= id=").append(owner.getId()).append(", role=").append(owner.getRole()).append("]\n");
		} else {
			builder.append("[owner= null]\n");
		}
		if (login != null) {
			builder.append("[login: id=").append(login.getId()).append(", role=").append(login.getRole()).append("]\n");
		} else {
			builder.append("[login: id= null]\n");
		}
