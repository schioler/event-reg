...
import dk.schioler.shared.security.entity.visitor.OwnerTreeToListVisitor;
//import dk.schioler.shared.security.entity.impl.OwnerTreeToListVisitor;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpSession;

/**
 * Involved in loginmanagement; 
 *    UserProfile: 
...
@Controller
public class LoginController extends AbstractController implements WebEntitySymbolsShared {
...
//   public static final String FAVORITES_SHOW = "redirect:../favorites-show.do";
   ...
   /*
    * <a href="login.list.show.do"> <a href="login.search.show.do"> <a
    * href="login.tree.show.do">
    */

   @RequestMapping(value = SECURE + SLASH + LOGIN_TREE_SHOW, method = RequestMethod.GET)
   public String loginTreeShow(@RequestParam Map<String, String> params, Model model, HttpServletRequest request) {
      ...
      if (wl != null) {
         ...
         return REDIRECT + SLASH + SECURE + SLASH + LOGIN_TREE_JSP;
      }

      return SLASH;
   }

   @RequestMapping(value = SECURE + SLASH + SES_LOGIN_SEARCH_SHOW, method = RequestMethod.GET)
   public String loginSearchShow(@RequestParam Map<String, String> params, Model model, HttpServletRequest request) {
...
//         session.setAttribute(SES_LOGIN_TREE, asList);
         ...
         return REDIRECT + SLASH + SECURE + SLASH + LOGIN_SEARCH_JSP;
      }

      return SLASH;
   }

   @RequestMapping(value = SECURE + SLASH + LOGIN_LIST_SHOW, method = RequestMethod.GET)
   public String loginListShow(@RequestParam Map<String, String> params, Model model, HttpServletRequest request) {
...
//         session.setAttribute(SES_LOGIN_TREE, asList);
         ...
         return REDIRECT + SLASH + SECURE + SLASH + LOGIN_LIST_JSP;
      }
...
//   public String loginSetNewPassword(@RequestParam Map<String, String> params, Model model, HttpServletRequest request) {
...
//   public String loginShowForgotPassword(@RequestParam Map<String, String> params, Model model, HttpServletRequest request) {
