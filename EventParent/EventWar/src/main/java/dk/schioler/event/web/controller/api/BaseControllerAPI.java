...
public interface BaseControllerAPI {
   ...
   public static final String LOGIN_JSP = REDIRECT + PUBLIC + SLASH + "login.jsp";
...
//   public static final String REQ_EVENT_TYPE_ID = "req-event-type-id";
   ...
   // REQUESTS
   public static final String PUBLIC_USER_AUTHENTICATE = PUBLIC + SLASH + "user-authenticate.do";
