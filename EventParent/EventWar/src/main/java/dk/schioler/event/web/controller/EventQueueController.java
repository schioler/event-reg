...
import dk.schioler.event.web.controller.api.EventQueueControllerAPI;
import dk.schioler.event.web.entity.WebLogin;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpSession;

@Controller
public class EventQueueController extends AbstractController implements EventQueueControllerAPI{
