   ...
   <div>
         <Div class="center-col-50-50">
            ...
            <DIV class="center-col-50-50-right">
                 <div  >
                          <input type="text" disabled="disabled" name="name" autofocus="autofocus"  value="${sesEventTemplate.name }"/>                     
                 </div>
            </DIV>
            ...
            <DIV class="center-col-50-50-right">
                 <div > 
                  <input type="text" disabled="disabled"  name="short-name" value="${sesEventTemplate.shortName }">
                  </div>                
             </DIV>
            ...
            <div class="center-col-50-50-right"> 
                 <input type="text" disabled="disabled"  name="dose" id="dose" value="${sesEventTemplate.dose}">
             </div>            
            ...
            <div class="center-col-50-50-right">
                <%-- <input type="text" name="unit" id="unit" value="${sesEventTemplate.unit}"> --%>
                  ...
                  <select disabled="disabled"  name="unit" id="unit">
                        <c:choose>
            ...
            <div class="center-col-50-50-right">
                  <input type="text" id="description" disabled="disabled"  name="description" value="${sesEventTemplate.description }">
             </div>
            ...
            <div class="center-col-50-50-right">
                  <c:choose>
                     <c:when test="${sesEventTemplate.favorite == true }">
                        <select disabled="disabled"  name="is-favorite" id="is-favorite">
            ...
            <div class="center-col-50-50-right">
                 <input disabled="disabled" type="text" id="sort-order" name="sort-order" value="${sesEventTemplate.sortOrder}">
            </div>
