            ...
            <c:choose>
                        <c:when test="${param.action eq 'create'}">
                           <form action="./event-type-create.do" method="post">
                                 <jsp:include page="include/event-type.jsp">
                                    <jsp:param value="yes" name="editable"/>
                                 </jsp:include>
                        ...
                        <c:when test="${param.action eq 'delete'}">
                           <form action="./event-type-delete.do" method="post">
                              <jsp:include page="include/event-type.jsp">
                                    <jsp:param value="no" name="editable"/>
                              </jsp:include>
                           </form>                         
                        </c:when>
                        <c:otherwise><p>Type action=${param.action }</p></c:otherwise>
               </c:choose> 
