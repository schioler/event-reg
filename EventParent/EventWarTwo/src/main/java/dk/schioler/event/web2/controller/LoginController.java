...
import dk.schioler.event.web2.common.WebCommonAPI;
...
//   public static final String FAVORITES_SHOW = "redirect:../favorites-show.do";
   ...
   @RequestMapping(value = "loginTreeShow.do", method = RequestMethod.GET)
...
//         ownerTree.accept(visitor, 0);
         ...
         return "redirecg:" + "/"+ "secure"+ "/"+ "login-tree.jsp";
      }

      return "/";
   }

   @RequestMapping(value = SES_LOGIN_SEARCH_SHOW, method = RequestMethod.GET)
...
//         session.setAttribute(SES_LOGIN_TREE, asList);
         ...
         return "redirect" + LOGIN_SEARCH_JSP;
      }

      return "/";
   }

   @RequestMapping(value =  LOGIN_LIST_SHOW, method = RequestMethod.GET)
...
//         session.setAttribute(SES_LOGIN_TREE, asList);
         ...
         return "redirect:" + LOGIN_LIST_JSP;
      }
